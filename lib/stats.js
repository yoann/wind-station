...
/**
 * Smoothing window shared by the dial readout and the direction chart's mean
 * line. Kept in one place so the two cannot drift: the right-hand end of the
 * chart line is the number under the dial.
 */
